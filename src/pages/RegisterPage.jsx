      ...
      <div className="w-full p-16">
        ...
        <header className="text-center relative h-10">
          ...
          <div className="cursor-pointer text-3xl font-semibold">
            <h4 className={`inline mx-3 ${loginStat?"opacity-30":null}`} onClick={()=>setLoginStat(prev=>!prev)}>Sign Up</h4>/
            <h4 className={`inline mx-3 ${!loginStat?"opacity-30":null}`} onClick={()=>setLoginStat(prev=>!prev)}>Log In</h4>
          </div>
        </header>
